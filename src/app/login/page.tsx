    ...
    <main className="grid min-h-screen bg-zinc-950 lg:grid-cols-[1.08fr_0.92fr]">
      <section className="relative hidden overflow-hidden border-r border-white/10 px-12 py-10 text-white lg:flex lg:flex-col">
        ...
        <div className="relative flex items-center gap-3 font-semibold">
          <span className="grid size-10 place-items-center rounded-xl bg-white p-1 shadow-lg shadow-emerald-950/20"><Image src="/dkpp-admin-logo.png" alt="" width={36} height={36} className="size-8 object-contain" priority /></span>
          <span className="text-lg">DKPP-Admin</span>
        </div>
        ...
        <p className="relative text-sm text-zinc-600">© 2026 DKPP-Admin</p>
      </section>
      <section className="flex min-h-screen items-center justify-center bg-zinc-50 px-5 py-12 sm:px-10">
        <div className="w-full max-w-md">
          <Link href="/" className="mb-10 flex items-center gap-3 font-semibold text-zinc-950 lg:hidden"><span className="grid size-9 place-items-center rounded-xl bg-white p-1 ring-1 ring-zinc-200"><Image src="/dkpp-admin-logo.png" alt="" width={32} height={32} className="size-7 object-contain" priority /></span>DKPP-Admin</Link>
          <div className="mb-8">
